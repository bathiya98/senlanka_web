	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Sen Lanka Mobile Mart</a>
			</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-12">
                <h4 class="font-rubik font-size-20">Sen Lanka</h4>
                <p class="font-size-14 font-rale text-white-50">Give a Cool Touch To Your Mobile Accessories</p>
            </div>
